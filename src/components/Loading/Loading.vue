<template lang="html">
  <div :class="['mimeloading-box', {'active': show}]">
    <div :class="['mimeloading', status]">
      <div class="mml-mask"></div>
      <div class="mml-wrap">
        <div class="mml-book"><span></span></div>
        <div class="mml-badge-cycle"></div>
        <div class="mml-badge"></div>
      </div>
      <div class="mml-cycle-wrap">
        <div class="mml-cycle-s4"><span></span><span></span></div>
        <div class="mml-cycle-s8"><span></span><span></span><span></span><span></span></div>
        <div class="mml-cycle"></div>
      </div>
    </div>
  </div>
</template>
...
.mimeloading.starting {
  .mml-badge {
    animation: badge-fadeIn 0.25s ease-out;
  }

  .mml-badge-cycle {
    opacity: 0;
    animation: badge-cycle-show 0.125s ease-out;
    animation-fill-mode: forwards;
    animation-delay: 0.25s;
  }

  .mml-book {
    animation: book-scaleIn 0.25s ease-out;
  }

  .mml-cycle {
    opacity: 0;
    animation: cycle-show 0.5s ease-out;
    animation-fill-mode: forwards;
  ...
  .mml-cycle-s8 {
    ...
    span {
      animation: s1-rotate 0.25s linear;
      animation-fill-mode: forwards;
      animation-delay: 1s;
    }

    span+span {
      animation: s2-rotate 0.25s linear;
      animation-fill-mode: forwards;
      animation-delay: 1s;
    }

    span+span+span {
      animation: s3-rotate 0.25s linear;
      animation-fill-mode: forwards;
      animation-delay: 1s;
    }

    span+span+span+span {
      animation: s4-rotate 0.25s linear;
      animation-fill-mode: forwards;
      animation-delay: 1s;
    }
  }
...
.mimeloading.ending {
  .mml-badge {
    animation: badge-fadeOut 0.5s ease-out;
    animation-fill-mode: forwards;
